...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>', 'dot'); ?><br />
		...
		{
			echo '<p>'. __('To use I Recommend This in your posts and pages you can use the shortcode:', 'dot') .'</p>
				...
				case 'get':
					...
					*/
					...
					if( ($recommended == 0) &&  $options['hide_zero'] == 1 ) {
						...
						$output = '<span class="glyphicon glyphicon-heart"></span><span class="dot-irecommendthis-count">&nbsp;</span> <span class="dot-irecommendthis-suffix slim gray">'. $suffix .'</span>';

						return $output;

					} else {

						$output = '<span class="glyphicon glyphicon-heart"></span><span class="dot-irecommendthis-count">'. $recommended .'</span> <span class="dot-irecommendthis-suffix slim gray">'. $suffix .'</span>';
