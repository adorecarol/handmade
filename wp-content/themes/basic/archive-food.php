...
?>
		...
		<div class="arc-post-full">
			...
			$archive_food_feat = new WP_Query(array(
			     'post_type' => 'food',
			     'showposts' => 1,
			     'orderby' => 'rand',
			));
			...
			while ($archive_food_feat->have_posts()) : $archive_food_feat->the_post(); 
		...
		<h1 class="feat-title text-center">MORE RECIPES</h1>
		...
		<br><br>
			...
			$archive_food = new WP_Query(array(
					'showposts' => 999,
					'post_type' => 'food',
				...
				while ($archive_food->have_posts()) : $archive_food->the_post(); ?>
