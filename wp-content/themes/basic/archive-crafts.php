...
?>
		...
		<div class="arc-post-full">
			...
			$archive_crafts_feat = new WP_Query(array(
			     'post_type' => 'crafts',
			     'showposts' => 1,
			     'orderby' => 'rand',
			));
			...
			while ($archive_crafts_feat->have_posts()) : $archive_crafts_feat->the_post(); 
		...
		<h1 class="feat-title text-center">MORE ARTS & CRAFTS</h1>
		...
		<br><br>
			...
			$archive_crafts = new WP_Query(array(
					'showposts' => 999,
					'post_type' => 'crafts',
				...
				while ($archive_crafts->have_posts()) : $archive_crafts->the_post(); ?>
